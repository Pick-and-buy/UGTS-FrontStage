          ...
          <View>
            ...
            {!isAuthenticated ? (
              ...
              <>
                ...
                >
                  <ProfileTile title={"Địa chỉ"} icon={"location-pin"} font={4} isDivider={true} onPress={() => navigation.navigate("address-lists", { type: 'profile' })} />
                  ...
                  <ProfileTile title={"Xác minh tài khoản"} icon={"verified-user"} font={4} isDivider={true} onPress={()=> navigation.navigate("IDRecognition")}/>
